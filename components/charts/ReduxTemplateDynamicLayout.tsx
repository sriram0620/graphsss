...
import { ReduxTemplateChart } from './ReduxTemplateChart';
...
interface ReduxTemplateDynamicLayoutProps {
...
export function ReduxTemplateDynamicLayout({ 
  templateDetail, 
  kpiInfo, 
  dateRange,
  theme 
}: ReduxTemplateDynamicLayoutProps) {
